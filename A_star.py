...
class hanoi():
    def __init__(self):
        ...
        self.plays = {1: 2, 2: 4,
                      3: 8}  # em que cada jogada o disco será mexido, 2^(peso do disco), Obs: inicia a contagem a partir do primeiro movimento
    ...
    def _t(self, k):  # ve se jogada atual é a esperada
        ...
        if self.move > self.first_movement[k]:
            value = self.move
            while value > self.first_movement[
                k]:  # regreção para descobrir de qual movimento eu partir e assim desobri se o valor atual de jogadas está na jogada do disco
